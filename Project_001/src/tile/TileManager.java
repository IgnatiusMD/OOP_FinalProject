...
public class TileManager {
	...
	public void getTileImage() {
		...
		try {
			...
			tile[1] = new Tile();
			tile[1].image = ImageIO.read(getClass().getResourceAsStream("/tiles/hill.png"));
	...
	public void draw(Graphics2D g2) {
		...
		g2.drawImage(tile[1].image, 0, 336, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 0, 384, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 0, 432, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 0, 480, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 0, 528, gp.tileSize, gp.tileSize, null);
		...
		g2.drawImage(tile[1].image, 720, 240, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 720, 288, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 720, 336, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 720, 384, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 720, 432, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 720, 480, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 720, 528, gp.tileSize, gp.tileSize, null);
		
		g2.drawImage(tile[1].image, 0, 528, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 48, 528, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 96, 528, gp.tileSize, gp.tileSize, null);
		...
		g2.drawImage(tile[1].image, 288, 528, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 336, 528, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 384, 528, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 432, 528, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 480, 528, gp.tileSize, gp.tileSize, null);
		...
		g2.drawImage(tile[1].image, 672, 528, gp.tileSize, gp.tileSize, null);
		...
		g2.drawImage(tile[0].image, 336, 192, gp.tileSize, gp.tileSize, null);
		...
		g2.drawImage(tile[1].image, 672, 240, gp.tileSize, gp.tileSize, null);
		...
		g2.drawImage(tile[1].image, 672, 288, gp.tileSize, gp.tileSize, null);
		
		//Row 6
		g2.drawImage(tile[1].image, 48, 336, gp.tileSize, gp.tileSize, null);
		g2.drawImage(tile[1].image, 96, 336, gp.tileSize, gp.tileSize, null);
		...
		g2.drawImage(tile[1].image, 672, 336, gp.tileSize, gp.tileSize, null);
		...
		g2.drawImage(tile[1].image, 672, 384, gp.tileSize, gp.tileSize, null);
